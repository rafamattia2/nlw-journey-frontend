          ...
          <div className="space-y-6">
            ...
            <div className="space-y-5">
              <div className="flex items-center justify-between gap-4">
                ...
                <Link2 className="text-zinc-400 size-55 shrink-0" />
              </div>
              <div className="flex items-center justify-between gap-4">
                <div className="space-y-1.5">
                  <span className="block font-medium text-zinc-100">Reserva do AirBnB</span>
            ...
            <button className="w-full bg-zinc-800 text-zinc-200 rounded-lg px-5 h-11 justify-center font-medium flex items-center gap-2 hover:bg-zinc-700">
          ...
          <div className="space-y-6">
            ...
            <div className="space-y-5">
              <div className="flex items-center justify-between gap-4">
                ...
                <CircleDashed className="text-zinc-400 size-55 shrink-0" />
              </div>
              <div className="flex items-center justify-between gap-4">
                <div className="space-y-1.5">
        ...
        <div className="fixed inset-0 bg-black/60 flex items-center justify-center">
          <div className="w-[640px] rounded-xl py-5 px-6 shadow-shape bg-zinc-900 space-y-5">
            <div className="space-y-2">
              <div className="flex items-center justify-between">
                <h2 className="text-lg font-semibold">Criação de atividade</h2>
            ...
            <form className="space-y-3">
              ...
              <div className="flex items-center gap2">
                <div className="py-2.5 flex-1 bg-zinc-950 border border-zinc-800 rounded-lg flex items-center gap-2">
